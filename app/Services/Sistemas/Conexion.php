...
use App\Models\Sistemas\Conexion as tablaConexion;
...
class Conexion
{
    ...
    {
        $response = tablaConexion::where('NAME_CONNECTION', $this->name_connection)
    ...
    {
        return tablaConexion::where('NAME_CONNECTION', $this->name_connection)->first(['DB_DATABASE']);
    }
}
