<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="{{ route('recursoshumanos.salidapersonal.vacacion.store1') }}" method="POST" role="form"
            id="formVacacion1">
            @csrf
            <input type="hidden" name="IDVACACION" value="{{ $idVacacion }}">
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td style="width:10%"><input type="date" name="FECHAI" id="FECHAI" required
                                    value="{{ date('Y-m-d') }}" class='form-control text-right'></td>
            ...
            <div class="form-group row">
                ...
                <div class="col-8 col-sm-4 col-md-3">
                    <input type="date" name="FECHARETORNO" id="FECHARETORNO" required value="{{ date('Y-m-d') }}"
                        class='form-control text-right'>
                </div>
            </div>
            <div class="form-group row">
