<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="{{ route('recursoshumanos.area.update', $area) }}" method="POST" role="form" id="formArea">
            @csrf
            @method('PUT')
            <div class="form-group row">
                <label for="codigo" class='col-3 offset-1 col-form-label'>C&oacute;digo:</label>
                <div class="col-6">
                    <input type="text" name="codigo" id="codigo" required maxlength="5" value="{{ $area->codigo }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" name="descripcion" id="descripcion" required maxlength="200"
                        value="{{ $area->descripcion }}" placeholder='Ingrese la descripción del area'
                        class='form-control'>
                </div>
            </div>
            <div class="form-group row">
