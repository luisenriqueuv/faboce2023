<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="{{ route('recursoshumanos.prueba.update', $prueba->ID) }}" method="POST" role="form"
            id="formPrueba">
            @csrf
            @method('PUT')
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" name="DETALLE" id="DETALLE" required maxlength="20"
                        value="{{ $prueba->DETALLE }}" placeholder='Ingrese el detalle' class='form-control'>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" name="DETALLE_1" id="DETALLE_1" required maxlength="20"
                        value="{{ $prueba->DETALLE_1}}" placeholder='Ingrese el Detalle' class='form-control'>
                </div>
            </div>
            <div class="form-group row">
