<div class="card border-secondary border-top-2 border-bottom-2">
    <div class="card-header bg-light header-elements-inline">
        <h5 class="card-title">
            ...
            <b>Codificador de Cargos</b>
        </h5>
    </div>
    <div class="card-body">
        <form action="{{ route('recursoshumanos.cargo.update', $cargo) }}" method="POST" role="form" id="formCargo">
            @csrf
            @method('PUT')
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" name="descripcion" id="descripcion" required maxlength="200"
                        value="{{ $cargo->descripcion }}" placeholder='Ingrese la descripción del cargo'
                        class='form-control'>
                </div>
            </div>
            <div class="form-group row">
