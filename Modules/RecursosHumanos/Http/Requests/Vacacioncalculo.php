...
class VacacioncalculoRequest extends FormRequest
{
    protected $vacacioncalculoService;

    public function __construct(VacacioncalculoService $vacacioncalculoService)
    {
        $this->vacacioncalculoService = $vacacioncalculoService;
    }
...
//        @Dump($ID);
    ...
    {
        return $this->vacacioncalculoService->crearIdDocumento($FechaSolicitud);
    }
