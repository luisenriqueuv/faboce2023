...
class ReemplazoRepository
{
    ...
    public function __construct(Reemplazo $model)
    {
        $this->_model = $model;
    ...
    public function all()
    {
        return $this->_model->on($this->_db)
            ...
            ->get(['ID','CARNET','NOMBRE_COMPLETO','FECHA_SOLICITUD','SECCION','FECHA_INICIO_SOLICITUD','HORA_INICIO_SOLICITUD','FECHA_FIN_SOLICITUD','HORA_FIN_SOLICITUD','TOTAL_DIAS','TOTAL_HORAS','OBSERVACION','TOTAL_DIAS','TOTAL_HORAS','OBSERVACION','DELETED_ID']);
    }
    ...
    {
        return $this->_model->withTrashed()->with('reemplazo')->find($id);
    }
    ...
    {
        return $this->_model->on($this->_db)->find($id, ['ID','CARNET','NOMBRE_COMPLETO','FECHA_SOLICITUD','SECCION','FECHA_INICIO_SOLICITUD','HORA_INICIO_SOLICITUD','FECHA_FIN_SOLICITUD','HORA_FIN_SOLICITUD','TOTAL_DIAS','TOTAL_HORAS','OBSERVACION','TOTAL_DIAS','TOTAL_HORAS','OBSERVACION','DELETED_ID']);
    }
