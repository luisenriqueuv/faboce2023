...
use Modules\RecursosHumanos\Facades\Vacacioncalculo as FacadesVacacioncalculo;
use Modules\RecursosHumanos\Repositories\VacacioncalculoRepository;

class VacacioncalculoService
{
    private const IDTIPOREGISTRO = 4;
//    private $repository;
    private $_repository;
    public function __construct(VacacioncalculoRepository $repository)
    {
    ...
    public function obtenerUltimoRegistro(){
        $ultimoReg = FacadesVacacioncalculo ::all();
        return $ultimoReg;
    }
