...
use Modules\RecursosHumanos\Facades\Compensacion as FacadesCompensacion;
...
//    private $repository;
    private $_repository;
    public function __construct(CompensacionRepository $repository)
    {
    ...
    public function obtenerUltimoRegistro(){
        $ultimoReg = FacadesCompensacion ::all();
        return $ultimoReg;
    }
