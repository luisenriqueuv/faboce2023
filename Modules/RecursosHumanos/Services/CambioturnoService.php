...
use Modules\RecursosHumanos\Facades\Cambioturno as FacadesCambioturno;
use Modules\RecursosHumanos\Repositories\CambioturnoRepository;

class CambioturnoService
{
    private const IDTIPOREGISTRO = 8;
    //    private $repository;
    private $_repository;
    public function __construct(CambioturnoRepository $repository)
    {
    ...
    public function obtenerUltimoRegistro(){
        $ultimoReg = FacadesCambioturno ::all();
        return $ultimoReg;
    }
