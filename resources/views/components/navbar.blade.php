<div class="navbar navbar-expand-md navbar-dark">
    <div class="text-center">
        <a href="/" class="d-inline-block mt-1">
            <img src="{{ asset('images/faboce.png') }}" width="60%" alt="Faboce S.R.L.">
        </a>
    </div>
    <div class="d-md-none">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle"
                    ...
                    <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&color=FFF&background=324148&bold=true"
                        width="36" height="36" class="rounded-circle" alt="{{ auth()->user()->name }}">
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('profile') }}" class="dropdown-item"><i class="icon-user-plus"></i>Perfil</a>
