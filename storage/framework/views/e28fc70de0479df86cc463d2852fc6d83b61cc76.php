                    ...
                    <select width="100%" class="form-control" required id='SECCION' name="SECCION">
                        ...
                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($area->DESCRIPCION); ?>"
                                <?php if($compensacion->SECCION==$area->DESCRIPCION): ?>
                                    selected
                                <?php endif; ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_INICIO_SOLICITUD" id="FECHA_INICIO_SOLICITUD" required maxlength="10"
                        placeholder='Fecha de Solicitud' class='form-control' value="<?php echo e($compensacion->FECHA_INICIO_SOLICITUD); ?>">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_INICIO_SOLICITUD" id="HORA_INICIO_SOLICITUD" maxlength="8"
                    placeholder='Hora de Solicitud' class='form-control' value="<?php echo e($compensacion->HORA_INICIO_SOLICITUD); ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_FIN_SOLICITUD" id="FECHA_FIN_SOLICITUD" required maxlength="10"
                        placeholder='Fecha Fin de Solicitud' class='form-control' value="<?php echo e($compensacion->FECHA_FIN_SOLICITUD); ?>">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_FIN_SOLICITUD" id="HORA_FIN_SOLICITUD" maxlength="8"
                    placeholder='Hora Fin de Solicitud' class='form-control' value="<?php echo e($compensacion->HORA_FIN_SOLICITUD); ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-3">
                    ...
                    placeholder='Total Dias' class='form-control' value="<?php echo e($compensacion->TOTAL_DIAS); ?>">
                </div>
                <div class="col-3">
                    <input type="time" name="TOTAL_HORAS" id="TOTAL_HORAS" readonly="true" maxlength="8"
                    placeholder='Total Horas' class='form-control' value="<?php echo e($compensacion->TOTAL_HORAS); ?>">
                </div>
            </div>
            <div class="form-group row">
...
</script><?php /**PATH C:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/compensacion/edit.blade.php ENDPATH**/ ?>