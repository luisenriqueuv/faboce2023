<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('recursoshumanos.descanso.store')); ?>" method="POST" role="form" id="formDescanso">
            ...
            <div class="form-group row">
                <label for="FECHA_RETORNO" class='col-3 offset-1 col-form-label'><b>Retorno :</b></label>
                <div class="col-6">
...
</script><?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/descanso/create.blade.php ENDPATH**/ ?>