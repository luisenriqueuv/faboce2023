...
$pdf->AddPage();
$pdf->AliasNbPages();
$pdf->SetTitle('Boleta de Vacacion');
...
$pdf->Cell(80, 6, utf8_decode('VACACIÓN'), 'TBR', 0, 'L', true);
$pdf->Cell(10);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(40, 6, 'MOTIVO DE SALIDA:', 'TBL', 0, 'L', true);
$pdf->SetFont('Arial', 'IB', 8);
...
$pdf->Output();
exit();
 ?><?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/salidapersonal/vacacion/pdf.blade.php ENDPATH**/ ?>