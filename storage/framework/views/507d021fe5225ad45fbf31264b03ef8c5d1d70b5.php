<div class="card border-secondary border-top-2 border-bottom-2">
    <div class="card-header bg-light header-elements-inline">
        <h5 class="card-title">
            ...
            <b>Codificador de Compensacion</b>
        </h5>
    </div>
    <div class="card-body">
        <form action="<?php echo e(route('recursoshumanos.compensacion.update',$compensacion->ID)); ?>" method="POST" role="form"
            id="formCompensacion">
            <?php echo csrf_field(); ?>
                    ...
                    <select width="100%" class="form-control" required id='NOMBRE_COMPLETO' name="NOMBRE_COMPLETO">
                        ...
                        <?php $__currentLoopData = $nombrespersonas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nombrepersona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($nombrepersona->NOMBRE.' '.$nombrepersona->APELLIDO.' |'.$nombrepersona->CARNET); ?>"
                                <?php if($compensacion->CARNET==$nombrepersona->CARNET): ?>
                                    selected
                                <?php endif; ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="date" name="FECHA_SOLICITUD" id="FECHA_SOLICITUD" required maxlength="10"
                        placeholder='Fecha de Solicitud' class='form-control' value="<?php echo e($compensacion->FECHA_SOLICITUD); ?>">
                </div>
            </div>
            <div class="form-group row">
                    ...
                    <select width="100%" class="form-control" required id='SECCION' name="SECCION">
                        ...
                        <?php $__currentLoopData = $secciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($seccion->ID); ?>"
                                <?php if($compensacion->SECCION==$seccion->ID): ?>
                                    selected
                                <?php endif; ?>    
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_INICIO_SOLICITUD" id="FECHA_INICIO_SOLICITUD" required maxlength="10"
                        placeholder='Fecha de Solicitud' class='form-control' value="<?php echo e($compensacion->FECHA_INICIO_SOLICITUD); ?>" onclick="calcularDias()" onchange="calcularDias()">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_INICIO_SOLICITUD" id="HORA_INICIO_SOLICITUD" maxlength="8"
                    placeholder='Hora de Solicitud' class='form-control' value="<?php echo e($compensacion->HORA_INICIO_SOLICITUD); ?>" onclick="calcularHoras()" onchange="calcularHoras()">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_FIN_SOLICITUD" id="FECHA_FIN_SOLICITUD" required maxlength="10"
                        placeholder='Fecha Fin de Solicitud' class='form-control' value="<?php echo e($compensacion->FECHA_FIN_SOLICITUD); ?>" onclick="calcularDias()" onchange="calcularDias()">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_FIN_SOLICITUD" id="HORA_FIN_SOLICITUD" maxlength="8"
                    placeholder='Hora Fin de Solicitud' class='form-control' value="<?php echo e($compensacion->HORA_FIN_SOLICITUD); ?>" onclick="calcularHoras()" onchange="calcularHoras()">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-3">
                    ...
                    placeholder='Total Dias' class='form-control' value="<?php echo e($compensacion->TOTAL_DIAS); ?>" onclick="calcularDias()" onchange="calcularDias()">
                </div>
                <div class="col-3">
                    <input type="time" name="TOTAL_HORAS" id="TOTAL_HORAS" readonly="true" maxlength="8"
                    placeholder='Total Horas' class='form-control' value="<?php echo e($compensacion->TOTAL_HORAS); ?>" onclick="calcularHoras()" onchange="calcularHoras()">
                </div>
            </div>
            <div class="form-group row">
                <label for="OBSERVACION" class='col-3 offset-1 col-form-label'>Observaciones :</label>
                <div class="col-6">
                    <textarea type="text" name="OBSERVACION" id="OBSERVACION" required maxlength="200"
                        placeholder='Ingrese las Observaciones' class='form-control'><?php echo e($compensacion->OBSERVACION); ?></textarea>
                </div>
            </div>
            <div class="form-group row">
...
</script><?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/compensacion/edit.blade.php ENDPATH**/ ?>