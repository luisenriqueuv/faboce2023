<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('recursoshumanos.prueba.store')); ?>" method="POST" role="form" id="formPrueba">
            <?php echo csrf_field(); ?>
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" name="DETALLE" id="DETALLE" required maxlength="20"
                        placeholder='Ingrese el detalle' class='form-control'>
                </div>
            </div>
            <div class="form-group row">
...
<?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/prueba/create.blade.php ENDPATH**/ ?>