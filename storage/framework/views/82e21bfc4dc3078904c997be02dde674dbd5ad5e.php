<div class="card border-secondary border-top-2 border-bottom-2">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('recursoshumanos.cambioturno.store')); ?>" method="POST" role="form" id="formCambioTurno">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group row">
                <label class="col-sm-3 offset-1 col-form-label">Nombre Cambio turno:</label>
                <div class="col-sm-4">
...
<script>
    $(function() {
        ...
        $('#NOMBRE_REEMPLAZADO').select2({
            tags: true,
            placeholder: 'seleccione un Reemplazado',
            allowClear: true,
            dropdownParent: $("#modal_ajax"),
            width: 'resolve',
        }).on('change', function() {
        ...
        $('#NOMBRE_REEMPLAZO').select2({
            tags: true,
            placeholder: 'seleccione el Reemplazo',
            allowClear: true,
            dropdownParent: $("#modal_ajax"),
            width: 'resolve',
        }).on('change', function() {
...
</script><?php /**PATH C:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/cambioturno/create.blade.php ENDPATH**/ ?>