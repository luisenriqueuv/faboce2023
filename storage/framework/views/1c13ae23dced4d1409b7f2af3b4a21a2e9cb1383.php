    ...
    <div class="card-body">
        <form action="<?php echo e(route('recursoshumanos.compensacion.store')); ?>" method="POST" role="form" id="formCompensacion">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select width="100%" class="form-control" required id='NOMBRE_COMPLETO' name="NOMBRE_COMPLETO" required>
                        <option></option>
            ...
            <div class="form-group row">
                <label for="TOTAL" class='col-3 offset-1 col-form-label'>Total Dias/Horas :</label>
                <div class="col-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <textarea type="text" name="OBSERVACION" id="OBSERVACION" required maxlength="255"
                        placeholder='Ingrese las Observaciones' class='form-control' onkeyup="contarCaracteres()"></textarea>
                </div>
            </div>
            <div class="form-group row">
...
</script><?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/compensacion/create.blade.php ENDPATH**/ ?>