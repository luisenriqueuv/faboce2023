            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select width="100%" class="form-control" required id='SECCION' name="SECCION">
                        ...
                        <option value="<?php echo e($area->DESCRIPCION); ?>"
                            <?php if($reemplazo->SECCION==$area->DESCRIPCION): ?>
                                selected
                            <?php endif; ?>    
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_INICIO_SOLICITUD" id="FECHA_INICIO_SOLICITUD" required maxlength="10"
                        placeholder='Fecha de Solicitud' class='form-control' value="<?php echo e($reemplazo->FECHA_INICIO_SOLICITUD); ?>">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_INICIO_SOLICITUD" id="HORA_INICIO_SOLICITUD" maxlength="8"
                    placeholder='Hora de Solicitud' class='form-control' value="<?php echo e($reemplazo->HORA_INICIO_SOLICITUD); ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="date" name="FECHA_FIN_SOLICITUD" id="FECHA_FIN_SOLICITUD" required maxlength="10"
                        placeholder='Fecha Fin de Solicitud' class='form-control' value="<?php echo e($reemplazo->FECHA_FIN_SOLICITUD); ?>">
                </div>
                <div class="col-3">
                    <input type="time" name="HORA_FIN_SOLICITUD" id="HORA_FIN_SOLICITUD" maxlength="8"
                    placeholder='Hora Fin de Solicitud' class='form-control' value="<?php echo e($reemplazo->HORA_FIN_SOLICITUD); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="TOTAL_DIAS" class='col-3 offset-1 col-form-label'><b>Total Dias/Horas:</b></label>
                <div class="col-3">
                    <input type="text" name="TOTAL_DIAS" id="TOTAL_DIAS" maxlength="100"
                        placeholder='Total Dias' class='form-control' readonly value="<?php echo e($reemplazo->TOTAL_DIAS); ?>">
                </div>
                <div class="col-3">
                    <input type="text" name="TOTAL_HORAS" id="TOTAL_HORAS" maxlength="100"
                        placeholder='Total Horas' class='form-control' readonly value="<?php echo e($reemplazo->TOTAL_HORAS); ?>">
                </div>
            </div>
            <div class="form-group row">
...
</script><?php /**PATH C:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/reemplazo/edit.blade.php ENDPATH**/ ?>