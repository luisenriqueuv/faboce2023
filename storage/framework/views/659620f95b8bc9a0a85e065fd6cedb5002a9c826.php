...
use Modules\RecursosHumanos\Services\PDF\Compensacion\CompensacionPDF;

foreach ($compensacion as $compensaciones) {
    $datos = array(
    "ID"                    => $compensaciones->ID,
    "NOMBRE_COMPLETO"       => $compensaciones->NOMBRE_COMPLETO,
    "FECHA_SOLICITUD"       => $compensaciones->FECHA_SOLICITUD,
    "SECCION"               => $compensaciones->SECCION,
    "FECHA_INICIO_SOLICITUD"=> $compensaciones->FECHA_INICIO_SOLICITUD,
    "HORA_INICIO_SOLICITUD" => $compensaciones->HORA_INICIO_SOLICITUD,
    "FECHA_FIN_SOLICITUD"   => $compensaciones->FECHA_FIN_SOLICITUD,
    "HORA_FIN_SOLICITUD"    => $compensaciones->HORA_FIN_SOLICITUD,
    "TOTAL_DIAS"            => $compensaciones->TOTAL_DIAS,
    "TOTAL_HORAS"           => $compensaciones->TOTAL_HORAS,
    "OBSERVACION"           => $compensaciones->OBSERVACION);
    $idDocumento             = $compensaciones->ID;
}
...
$tipoDocumento =    'COMPENSACION';

$pdf = new CompensacionPDF();
$pdf->AddPage();
$pdf->AliasNbPages();
...
exit(); ?><?php /**PATH D:\xampp\htdocs\faboce2023\Modules/RecursosHumanos\Resources/views/compensacion/pdf.blade.php ENDPATH**/ ?>